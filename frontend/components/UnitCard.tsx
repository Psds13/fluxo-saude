...
export default function UnitCard({ unidade }: { unidade: Unidade }) {
  ...
  return (
    <div
      className={`rounded-3xl border-2 p-6 md:p-7 shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between ${
        altoContraste ? 'bg-black text-yellow-300 border-yellow-400' : 'bg-white text-slate-900 border-slate-200 hover:border-sky-400'
      }`}
    >
      <div className="space-y-4">
        {/* Header do Card com Tipo e Status */}
        ...
        {/* Nome da Unidade */}
        <h3 className="text-xl font-extrabold text-slate-900 leading-snug hover:text-sky-700 transition-colors">
        ...
        {/* Status Detalhado / Alerta se houver */}
      ...
      {/* Footer do Card com Timestamp Oficial + Ações */}

...
![Acessibilidade](https://img.shields.io/badge/Acessibilidade-WCAG_2.1-22C55E?style=for-the-badge)
...
1. Orientação inicial e clara sobre o tipo de serviço mais adequado.
2. Triagem simples, responsiva e acessível para celular.
3. Informações sobre serviços, horários, localização, telefone e tipos de unidade.
4. Explicação educacional sobre o papel de cada estrutura da rede de saúde.
5. Suporte futuro para municípios, secretarias e plataformas multi-tenant.
